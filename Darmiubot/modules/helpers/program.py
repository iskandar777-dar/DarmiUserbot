import shlex
from Darmiubot.modules.databases.afk_db import get_afk_status
from Darmiubot.modules.databases.pmpermit_db import get_approved_users, pm_guard
...
def GetFromUserID(message: Message):
    """ Dapatkan id pengguna dari pesan masuk."""
    return message.from_user.id


def GetChatID(message: Message):
    """ Dapatkan id grup dari pesan masuk"""
    return message.chat.id


def GetUserMentionable(user: User):
    """ Dapatkan teks yang dapat disebutkan dari pengguna."""
    if user.username:
